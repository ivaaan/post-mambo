			...
			<div className='container bg-blue'>
				<div className='inline-block mb-20'>
					<div className='grid grid-cols-8 gap-4 ml-20 mr-20 mb-20'>
						...
						{/* right of poster */}
						<div className='col-span-4 h-auto'>
							<h1 className='text-center text-silver text-7xl font-bold tracking-tighter'>
								Tahara
							</h1>
							...
							{/* description*/}
							<p className='mt-8 text-silver text-2xl tracking-tighter break-words indent-8'>
							...
							{/* quote */}
							<div className='text-pink font-light quote lowercase mt-8 text-center text-3xl tracking-tighter break-words border-l-2'>
								<p className='inline-block m-4 '>
									...
									<span className='text-silver'>{' — The New York Times'}</span>
								</p>
							</div>
						</div>
					</div>
