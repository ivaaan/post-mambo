			...
			<div className='container bg-blue'>
				<div className='inline-block mb-20'>
					<div className='grid grid-cols-8 gap-4 ml-0 mr-0 mb-20'>
						...
						{/* right of poster */}
						<div className='col-span-4 h-auto'>
							{/* <h1 className='uppercase text-silver text-9xl text-center font-picnic tracking-tight'>
								Tahara
							</h1> */}
							<h1 className='uppercase text-silver text-9xl text-center font-authenticSansCondensed60 tracking-tight -skew-x-12 -skew-y-12'>
								Tahara
							</h1>
							{/* sub-grid for credits */}
							{/* <div className='grid grid-cols-2 gap-2 mt-4'>
								<div className='text-silver text-center mt-1'>
									<p className='text-4xl font-bold credit tracking-tighter'>
										Olivia Peace
									</p>
									<p className='-mt-1 lowercase tracking-wide'>Director</p>
								</div>
								<div className='text-silver text-center mt-1'>
									<p className='text-4xl font-bold credit tracking-tighter'>
										Jess Zeidman
									</p>
									<p className='-mt-1 lowercase tracking-wide'>Writer</p>
								</div>
								<div className='text-silver text-center mt-1'>
									<p className='text-4xl font-bold credit tracking-tighter'>
										Justin Enoch
									</p>
									<p className='-mt-1 lowercase tracking-wide'>
										Sound Design, Foley
									</p>
								</div>
								<div className='text-silver text-center mt-1'>
									...
									<p className='-mt-1 lowercase tracking-wide'>Foley</p>
								</div>
							</div> */}
							{/* sub-grid for credits */}
							<div className='grid grid-cols-2 gap-2 mt-4 mr-4 font-authenticSansCondensed60 break-words'>
								<div className='credit rounded-full text-center border-solid border-2 outline-silver-500 shadow-inner '>
									<p className='mt-8 text-7xl uppercase font-picnic'>
										Olivia Peace
									</p>
									<p className='mb-8 text-xl lowercase'>Director</p>
								</div>
								<div className='credit bg-gradient-to-b from-silver text-center text-blue tracking-tight'>
									<p className='mt-8 text-7xl uppercase'>Jess Zeidman</p>
									<p className='mb-8 text-xl lowercase'>Writer</p>
								</div>
								<div className='credit rounded-lg bg-gradient-to-t from-pink text-center text-blue tracking-tight'>
									<p className='mt-8 text-7xl uppercase'>Troy Lewis</p>
									<p className='mb-8 text-xl lowercase'>Editor</p>
								</div>
								<div className='credit rounded-full bg-silver text-center text-blue tracking-tight'>
									<p className='mt-8 text-7xl uppercase font-picnic'>
										Justin Enoch
									</p>
									<p className='mb-8 text-xl lowercase'>Sound Design, Foley</p>
								</div>
								<div className='credit rounded-full bg-silver text-center text-blue tracking-tight'>
									<p className='mt-8 text-7xl uppercase'>Riona Ryan</p>
									<p className='mb-8 text-xl lowercase'>Foley</p>
								</div>
							</div>
							{/* description*/}
							<p className='mt-4 text-silver text-5xl font-authenticSans60'>
